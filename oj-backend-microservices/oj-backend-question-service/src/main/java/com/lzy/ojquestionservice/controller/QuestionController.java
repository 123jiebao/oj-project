package com.lzy.ojquestionservice.controller;
...
import com.lzy.ojmodel.model.dto.question.*;
...
import com.lzy.ojmodel.model.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Long> doQuestionSubmit(@RequestBody QuestionSubmitAddRequest questionSubmitAddRequest,
        ...
        // 登录才能提交
        final User loginUser = userFeignClient.getLoginUser();
    ...
    public BaseResponse<Page<QuestionSubmitVO>> listQuestionSubmitVOByPage(@RequestBody QuestionSubmitQueryRequest questionSubmitQueryRequest,
        ...
        Object userObj = userFeignClient.getLoginUser();

        User currentUser = (User) userObj;
        return ResultUtils.success(questionSubmitService.getQuestionSubmitVOPage(questionSubmitPage, currentUser));
    }
